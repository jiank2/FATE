...
from models.base_attack import BaseAttack


class DICE_S(BaseAttack):
    """
    NOTE: Modified from the DeepRobust source code.
    ...
    def attack(self, ori_adj, labels, n_perturbations, **kwargs):
        ...
        while added_edges < n_insert:
            ...
            candidate_edges = np.array(
                [
                    np.random.choice(ori_adj.shape[0], n_remaining),
                    np.random.choice(ori_adj.shape[0], n_remaining),
                ]
            ).T
            ...
            candidate_edges = set(
                [
                    ...
                    and modified_adj[u, v] == 0
                    and modified_adj[v, u] == 0
                ]
            )
